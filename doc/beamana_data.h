...
// Tue Jun 16 19:55:08 2020 by ROOT version 5.34/32
// from TTree beamana/beam analysis tree
// found on file: pionana_5387_6_15_20.root
//////////////////////////////////////////////////////////

#ifndef beanana_data_h
#define beanana_data_h
...
public :
   ...
   beanana_data(TTree *tree=0);
   virtual ~beanana_data();
...
#ifdef beanana_data_cxx
beanana_data::beanana_data(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("pionana_5387_6_15_20.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("pionana_5387_6_15_20.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("pionana_5387_6_15_20.root:/pionana");
...
beanana_data::~beanana_data()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t beanana_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t beanana_data::LoadTree(Long64_t entry)
{
...
void beanana_data::Init(TTree *tree)
{
...
void beanana_data::Show(Long64_t entry)
{
...
Int_t beanana_data::Cut(Long64_t entry)
{
