...
// Wed Jun 10 22:04:01 2020 by ROOT version 5.34/32
// from TTree beamana/beam analysis tree
// found on file: ../anaData/input/protoDUNE_reco_flattree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../anaData/input/protoDUNE_reco_flattree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../anaData/input/protoDUNE_reco_flattree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../anaData/input/protoDUNE_reco_flattree.root:/pionana");
